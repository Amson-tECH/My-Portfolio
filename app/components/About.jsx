      ...
      >
        ...
        >
          <Image
            ...
            alt="User"
            className="w-full rounded-3xl cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-gray-400 dark:hover:bg-darkHover/50"
          />
        </motion.div>
